...
<%
        ...
        if(request.getParameter("b1")!=null)
        {
                ...
                stmt.executeUpdate();
                stmt=con.prepareStatement("Insert into users values(?,?,'staff')");
                stmt.setString(1,request.getParameter("t1"));
...
<html>
    ...
    <body>
        ...
        <div style="width:84%;background-color: antiquewhite; float: right">
            <form method="post">
            <table align="center">
                <tr><th colspan="3">Manage Staff Members</th></tr>
                <tr>
            ...
            <%
                ...
                while(rs.next())        
                {
                    ...
                    out.write("<td><a href='setresign.jsp?p=S&email="+rs.getString(1)+"'>Resign</a></td>");
                    out.write("</tr>");
                }                    
            %>
            </table>
